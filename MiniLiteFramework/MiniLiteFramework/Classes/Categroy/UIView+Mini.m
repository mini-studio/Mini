...
- (UIImage *) imageByRenderingView:(CGRect)f
{
    ...
    CGImageRef imageRef =     CGImageCreateWithImageInRect(resultingImage.CGImage,CGRectMake(frame.origin.x*scale, frame.origin.y*scale, frame.size.width*scale, frame.size.height*scale));
