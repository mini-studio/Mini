...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        NSInteger maxWidth = (frame.size.width - 4 * margin);
        CGSize dims = [self.labelText sizeWithFont:self.labelFont constrainedToSize:CGSizeMake(maxWidth, MAXFLOAT) lineBreakMode:UILineBreakModeCharacterWrap];
