...
//    
//    double la = self.coordinate.latitude;
//    double lo = self.coordinate.longitude;	
...
//    
////    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:coordDict, @"coordinate", nil];
//	
//	return [coordDict description];
//}
